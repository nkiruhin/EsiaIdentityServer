...
namespace AspNet.Security.OAuth.Esia
{
    public static class EsiaConstants
    {
        ...
        public static readonly string SignServiceEndpoint = "http://85.233.74.77:8080/crypto/signPkcs7";
        public static readonly string RedirectUrlServiceEndpoint = "http://85.233.74.78:8080/esia/v1/redirectUrl";
        ...
        public static readonly string UserInformationScope = "fullname";
